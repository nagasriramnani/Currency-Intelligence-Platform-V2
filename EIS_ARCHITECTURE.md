...
The EIS Investment Scanner screens UK companies for Enterprise Investment Scheme (EIS) eligibility using Companies House data, AI-powered news analysis, and automated newsletter delivery.
...
|-----------|------------|---------|
| Frontend | Next.js 14, TypeScript, Tailwind CSS | UI & Styling |
| Backend | FastAPI, Python 3.11 | REST API |
| Charts | Recharts, Framer Motion | Visualizations |
...
| AI Intelligence | Tavily news per company |
| Watchlist | Companies needing review |
| Portfolio | Full company table |
...
│  ─────────                   ─────────                  ─────────────       │
│  • Next.js 14                • FastAPI                  • Companies House   │
│  • TypeScript                • Python 3.11              • Tavily AI         │
│  • Tailwind CSS              • Pandas                   • HuggingFace       │
│  • Framer Motion             • WeasyPrint               • Gmail SMTP        │
│  • Lucide Icons                                                             │
│  • Recharts                  AI MODELS                  STORAGE             │
│                              ─────────                  ─────────           │
│                              • Mistral 7B               • LocalStorage      │
│                              • Research Agent           • scan_history.json │
│                              • Editor Agent             • trained_models/   │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
| `HF_API_KEY` | HuggingFace | AI summarization |
